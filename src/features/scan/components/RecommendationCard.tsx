import type { Recommendation } from "../lib/pemeriksaanTypes";
...
function getProduct(item: Recommendation) {
        ...
        {recommendations.length > 0 ? (
                ...
                {product ? (
                  ...
                  <div className='border-t border-emerald-100 bg-white/70 px-4 py-3'>
                    <p className='text-xs font-semibold leading-5 text-slate-500'>
                      Gunakan rekomendasi ini sesuai kondisi kulit yang
                      terdeteksi. Hentikan penggunaan jika muncul iritasi.
                    </p>
                  </div>
                )}
              </article>
          ...
          <div className='rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-5 py-6 text-center'>
            <p className='text-sm font-semibold leading-6 text-slate-500'>
              Belum ada rekomendasi skincare. Lakukan pemeriksaan terlebih
              dahulu atau tunggu dokter menambahkan rule rekomendasi.
            </p>
          </div>
        )}
      </div>
