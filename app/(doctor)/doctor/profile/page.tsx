    ...
    <main className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
        ...
        <div className="w-full lg:w-64 shrink-0 flex flex-col gap-2">
          ...
          <Link href="/doctor/profile/login-security" className="flex items-center gap-3 px-4 py-3 text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900 font-medium rounded-xl transition-colors">
        ...
        <div className="flex-1 w-full min-w-0">
          {(!profile.verification_status || profile.verification_status === 'unverified') && (
            <div className="mb-6 p-4 bg-amber-50 border border-amber-200 flex items-start gap-3 rounded-xl">
              ...
              <div>
                <h4 className="font-semibold text-amber-800 text-sm">Akun Belum Terverifikasi</h4>
                <p className="text-xs text-amber-700 mt-1">Anda belum dapat membalas chat pasien. Harap lengkapi dokumen verifikasi Anda di halaman Dashboard Verifikasi.</p>
              </div>
            </div>
          )}
